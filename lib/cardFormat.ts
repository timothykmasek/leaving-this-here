...
const FORMATS: Record<string, CardFormat> = {
  ...
  article:    { label: 'Article', aspect: '3 / 2',   affordance: 'favicon' }, // image-on-top, landscape
  product:    { label: 'Product', aspect: TALL,      affordance: 'price' },   // padded catalog shot
  fullbleed:  { label: 'Product', aspect: '2 / 3',   affordance: 'price' },   // shop product photo
  composite:  { label: 'Post',    aspect: '1.91 / 1', affordance: 'favicon' }, // social og card
